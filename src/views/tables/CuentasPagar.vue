      ...
      <div>
        <v-card>
          ...
          <v-col>
            <v-sheet>
              ...
              <div style="position: relative; float: left">
                <p><b>{{cuentas}} cuentas por pagar /</b> {{page}} páginas</p>
              </div>
            </v-sheet>
          </v-col><br>
          <v-data-table
          ...
          >
            ...
            <template v-slot:item.operadora="{ item }" style="text-align:left;">
              <span style="font-size:13px;"> {{ formatNumber(item.operadora) }}</span>
            </template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "PAGADO POR LA OPERADORA", value: "operadora", align: "center" },
        { text: "POR PAGAR", value: "pagar", align: "center" },
      ],
      desserts: [
        {
          clave: 10005,
